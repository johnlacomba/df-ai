...
class Plan
{
    ...
    room *fort_entrance;
public:
    std::map<int32_t, std::vector<std::pair<df::coord, int32_t>>> map_veins;
private:
...
public:
    ...
    bool digroom(color_ostream & out, room *r, bool immediate = false, const std::set<df::coord> &skip_tiles = {});
